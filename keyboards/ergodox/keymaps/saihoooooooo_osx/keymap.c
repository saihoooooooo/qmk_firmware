 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |      |      |      | LAlt | LANG2|                                       | LANG1| RAlt |   [  |   ]  |   =  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        |      | Home |       | PgUp |       |
 *                                 ,------|------|------|       |------+-------+------.
 *                                 |      |      | End  |       | PgDn |       |      |
 *                                 | Space| Esc  |------|       |------| Enter | Bksp |
 *                                 |      |      | LGui |       | RGui |       |      |
 *                                 `--------------------'       `---------------------'
 */
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_NO    , KC_NO , KC_NO , KC_LALT , KC_LANG2 ,
                                                        KC_NO  , KC_HOME ,
                                                                 KC_END  ,
                                             KC_SPC   , KC_ESC , KC_LGUI ,
        // right hand
        KC_NO    , KC_6  , KC_7     , KC_8    , KC_9    , KC_0    , KC_MINS   ,
        MO(SYMB) , KC_Y  , KC_U     , KC_I    , KC_O    , KC_P    , KC_BSLASH ,
                   KC_H  , KC_J     , KC_K    , KC_L    , KC_SCLN , KC_QUOT   ,
        MO(MDIA) , KC_N  , KC_M     , KC_COMM , KC_DOT  , KC_SLSH , KC_RSFT   ,
                           KC_LANG1 , KC_RALT , KC_LBRC , KC_RBRC , KC_EQL    ,
        KC_PGUP  , KC_NO ,
        KC_PGDN  ,
